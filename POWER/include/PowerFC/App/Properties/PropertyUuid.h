#ifndef POWERFC_APP_PROPERTIES_PROPERTY_UUID_H_
#define POWERFC_APP_PROPERTIES_PROPERTY_UUID_H_
#pragma once
...
class PFC_APP_API PropertyUuid : public Property
{
  ...
  public:
    ...
    void SetValue(base::Uuid const& value);
    void SetValue(std::string_view value);
    base::Uuid const& GetValue() const;
    std::string_view GetString() const;

    std::string_view GetEditorTypeName() const override
    {
        return "Gui::PropertyEditor::PropertyUuidItem";
    }
...
#endif /* POWERFC_APP_PROPERTIES_PROPERTYUuid_H_ */