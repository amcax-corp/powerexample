 ...
 */
PFC_BASE_API std::size_t base64_encode(char* out, void const* in, std::size_t len);
 ...
 */
PFC_BASE_API std::array<const signed char, base64DecodeTableSize> base64_decode_table();
 ...
 */
PFC_BASE_API std::pair<std::size_t, std::size_t>
