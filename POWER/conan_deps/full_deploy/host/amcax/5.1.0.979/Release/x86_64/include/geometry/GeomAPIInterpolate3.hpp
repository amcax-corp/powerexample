...
/// @brief     Class of computing a curve interpolating 3D points
...
public:
	...
	AMCAX_API GeomAPIInterpolate3(const std::vector<Point3>& points, bool periodic, double tolerance);
	...
	/// @param periodic Whether constructing a periodic curve
	/// @param tolerance The computing tolerance
	AMCAX_API GeomAPIInterpolate3(const std::vector<Point3>& points, const std::vector<double>& parameters, bool periodic, double tolerance);
	...
	AMCAX_API void Load(const Vector3& initialTangent, const Vector3& finalTangent, bool scale = true);
	...
	/// @param scale Whether the tangent is to be scaled
	AMCAX_API void Load(const std::vector<Vector3>& tangents, const std::vector<bool>& tangentFlags, bool scale = true);
