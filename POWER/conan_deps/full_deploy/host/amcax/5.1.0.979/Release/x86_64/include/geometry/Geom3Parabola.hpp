...
{
/// @brief Class of 3D parabola
class AMCAX_CLASS_API Geom3Parabola : public Geom3Conic
{
public:
	/// @brief Default constructor
	constexpr Geom3Parabola() noexcept = default;

	/// @brief Construct from a parabola
	/// @param p The parabola
	AMCAX_API explicit Geom3Parabola(const Parabola3& p) noexcept;

	/// @brief Construct from a local frame and a focal length
	/// @param frame The local frame
	/// @param focal The focal length
	AMCAX_API Geom3Parabola(const Frame3& frame, double focal);

	/// @brief Construct from a directrix and a focus
	/// @param directrix The directrix
	/// @param focus The focus
	AMCAX_API Geom3Parabola(const Axis3& directrix, const Point3& focus);
	...
	/// @param p The parabola
	AMCAX_API void SetParabola(const Parabola3& p) noexcept;

	/// @brief Get the parabola
	/// @return The parabola
	[[nodiscard]] AMCAX_API Parabola3 Parabola() const noexcept;
	...
	[[nodiscard]] AMCAX_API Axis3 Directrix() const noexcept;
	...
	[[nodiscard]] AMCAX_API Point3 Focus() const noexcept;
