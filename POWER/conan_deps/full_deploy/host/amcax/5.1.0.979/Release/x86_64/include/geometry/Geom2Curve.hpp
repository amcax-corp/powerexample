...
{
/// @brief Base class of 2D curve
class AMCAX_CLASS_API Geom2Curve : public Geom2Geometry
{
public:
	...
	[[nodiscard]] AMCAX_API std::shared_ptr<Geom2Curve> Reversed() const;
	...
	[[nodiscard]] AMCAX_API virtual double TransformedParameter(double u, const Transformation2& tr) const noexcept;
	...
	[[nodiscard]] AMCAX_API virtual double ParametricTransformation(const Transformation2& tr) const noexcept;
	...
	[[nodiscard]] AMCAX_API virtual Vector2 DN(double u, int n) const = 0;

	/// @brief Compute the point at a parameter
	/// @param u The parameter
	/// @return The point
	[[nodiscard]] AMCAX_API Point2 Value(double u) const;
