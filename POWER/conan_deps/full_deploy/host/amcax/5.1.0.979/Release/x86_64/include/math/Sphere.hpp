...
{
/// @brief Class of sphere
class Sphere : public SurfaceBase<Sphere>
{
	using Base = SurfaceBase<Sphere>;
...
public:
	...
	/// @brief Get the area of the sphere
	...
	/// @brief Get the volume of the ball bounded by the sphere
	...
	AMCAX_API Sphere& Scale(const Point3& point, double scale) noexcept;

	/// @brief Transform the sphere
	/// @param tr The transformation
	/// @return The reference to self
	AMCAX_API Sphere& Transform(const Transformation3& tr) noexcept;

protected:
	void CheckValidity() const;

	/// @brief The radius of sphere
